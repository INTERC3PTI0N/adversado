        ...
        <div className="pl-orb relative h-full w-full overflow-hidden rounded-full">
          ...
          >
            <defs>
              ...
              {/* Hot core → saturated gold → electric rim — Engaged-level glow,
                  kept in brand gold / navy rather than teal. */}
              <radialGradient id={id("orbDeep")} cx="42%" cy="38%" r="68%">
                <stop offset="0%" stopColor="#fff8e8" />
                <stop offset="22%" stopColor="#ffe08a" />
                <stop offset="48%" stopColor="#e6b325" />
                <stop offset="72%" stopColor="#7a9ad4" />
                <stop offset="100%" stopColor="#2a3f78" />
              </radialGradient>
              <radialGradient id={id("goldHi")} cx="50%" cy="50%" r="50%">
                <stop offset="0%" stopColor="#fff3c0" stopOpacity="1" />
                <stop offset="28%" stopColor="#f0c84a" stopOpacity="0.95" />
                <stop offset="70%" stopColor="#e6b325" stopOpacity="0" />
              </radialGradient>
              <radialGradient id={id("blueLo")} cx="50%" cy="50%" r="50%">
                <stop offset="0%" stopColor="#c8dcff" stopOpacity="0.85" />
                <stop offset="50%" stopColor="#6b8fd4" stopOpacity="0.45" />
            ...
            <g mask={`url(#${id("punch")})`}>
              <rect
                ...
                fill={`url(#${id("orbDeep")})`}
              />
              <circle cx="320" cy="280" r="520" fill={`url(#${id("goldHi")})`} />
              ...
              <g opacity="0.55">
                <animateTransform
                  ...
                  repeatCount="indefinite"
                />
                <circle cx="560" cy="400" r="220" fill={`url(#${id("goldHi")})`} />
              </g>
