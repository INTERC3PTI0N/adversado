...
// React Bits — WarpText (JavaScript + CSS variant), converted to .tsx with
// prop types added for this project's strict TypeScript config. Logic,
// uniforms, and the rasterisation/render loop are otherwise unchanged from
// the supplied source.
...
const syncUniforms = (program: Program, props: TextProps) => {
...
const WarpText = ({
  ...
  const propsRef = useRef<TextProps>({
    text,
    color,
    fontSize,
    fontWeight,
